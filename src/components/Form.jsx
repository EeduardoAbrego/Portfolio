    ...
    <section id='contacto' className={style.section}>
      ...
      <div className={style.campoForm} >
          ...
          <div className={style.campo}>
            ...
            <input  className={ !errors.name ? style.input : style.inputerr } type="text" id="name" {...register('name',{
            required: {
              value: true,
        ...
        <input className={ !errors.email ? style.input : style.inputerr } type="email" autoComplete='off' id="email" {...register('email', {
            pattern : {
       ...
       { isValid && <button  id="miBoton"  className={style.button} type="submit">Enviar</button> }
      ...
      <div className={style.descrip}>
         ...
         <div className={style.textarea} >
           ...
           <textarea className={style.inputdes} autoComplete="off" type="" id="description" {...register('message',{
            required: {
              value: true,
              message: "Este campo es requerido"
            },
